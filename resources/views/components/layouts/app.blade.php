    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="btn btn-warning rounded-5 mx-2" aria-current="page" href="/users" wire:navigate>Users</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-warning rounded-5" href="/artists" wire:navigate>Artists</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-warning rounded-5 mx-2" href="/albums" wire:navigate>Albums</a>
                </li>
            </ul>
